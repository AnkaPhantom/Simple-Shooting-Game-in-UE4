...
#include "Components/SkeletalMeshComponent.h"  // for GetSocketLocation
...
void ASWeapon::Fire()
{
	...
	if (MyOwner)
	{
		...
		// record the time when fire completed
...
void ASWeapon::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME_CONDITION(ASWeapon, HitScanTrace, COND_SkipOwner); // Replicate any relevant client connecting to us
}
